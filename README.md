...
- 좌측에는 동전/지폐 투입구, 우측에는 지폐와 동전이 위치.
- 내 주머니에 들어있는 돈은 10,000원. 주머니 안의 돈은 동전과 지폐의 구분이 없음. 꺼내는 대로 지폐가 되기도, 동전이 되기도함. 이때, "꺼낸다"는 표현은 우측의 동전 또는 지폐 버튼을 클릭해서 드래그하는 것을 말함.
- 우측의 지폐 또는 동전을 드래그해서, 좌측 투입구에 드롭하면 돈을 __투입__한 것이 됨.
...
- 상품 전시 영역과 금전 투입 영역에서 발생하는 모든 행동에 대한 기록을 출력.
  - 행동리스트
    - 상품 전시 영역: 구매, 금액 부족, 품절, 꺼낼 수 있는 곳에 상품 등장(?)
    - 금전 투입 영역: 돈 꺼냄, 돈 주머니에 다시 넣음, 돈 투입, 돈 반환, 돈 떨굼, 돈 최대 투입한도 경고, 지폐 투입한도 경고
- 콘솔 내용은 스크롤이 가능하도록 함.
